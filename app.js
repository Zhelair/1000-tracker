...
function showPreview(d){
  previewDeltas = d;
  document.getElementById("pv1").textContent = d.player_1;
  document.getElementById("pv2").textContent = d.player_2;
  document.getElementById("pv3").textContent = d.player_3;
